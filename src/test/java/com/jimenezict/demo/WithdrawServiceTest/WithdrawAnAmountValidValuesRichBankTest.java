...
@SpringBootTest
public class WithdrawAnAmountValidValuesRichBankTest {
    ...
    public void init(){
        ...
        atmStatus.setNotes_20(10000000);
        atmStatus.setNotes_50(10000000);
    }
    ...
    public void generatesTheWithdrawByNotesTest25() {
        ...
        assertEquals(new Integer(1),nullWithDraw.getNotes_20());
        assertEquals(new Integer(0),nullWithDraw.getNotes_50());
    }
    ...
    public void generatesTheWithdrawByNotesTest45() {
        ...
        assertEquals(new Integer(1),nullWithDraw.getNotes_5());
        assertEquals(new Integer(0),nullWithDraw.getNotes_10());
        assertEquals(new Integer(2),nullWithDraw.getNotes_20());
        assertEquals(new Integer(0),nullWithDraw.getNotes_50());
    }
    ...
    public void generatesTheWithdrawByNotesTest55() {
        ...
        assertEquals(new Integer(0),nullWithDraw.getNotes_10());
        assertEquals(new Integer(0),nullWithDraw.getNotes_20());
        assertEquals(new Integer(1),nullWithDraw.getNotes_50());
    }
